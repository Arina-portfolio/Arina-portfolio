...
<ol>
  <li>Посчитать юнит-экономику продукта и предложить сценарий по настройке параметров для выхода на 25%-ую маржинальность</li>
...
<p>Что нужно было сделать:<p>
<ol>
  <li>Визуализировать динамику транзакций по ТТ. Ответить на вопрос, для какой торговой точки доля по кол-ву транзакций в течение 2020 года снижалась. Указать месяцы наибольшего роста и падения.</li>
...
<p>Как решала: Построила сводную таблицу по продажам. С помощью гистограммы с накоплениями визуализировала долю каждой ТТ в продажах по месяцам. Прогноз на следующий год построила на основе имеющейся статистики за 2 года с учетом коэффициента сезонности <p>
...
<ol>
  ...
  <li>Итог №3. Прогноз построила с учетом коэффициента сезонности, что составило +7% к текущим данным. </li>
</ol>
...
> <a href="Проект №4 SQL">Ссылка на проект</a>
...
<p>Как решала: Когорты назначила от первого месяца обучения студента. Определила через оконную функцию кол-во недель от предыдущего занятия. Выделила в отдельные таблицы всех учеников и учеников-прогульщиков. Объединила запросы в один и рассчитала долю прогульщиков<p>

> <a href="Проект №5 SQL">Ссылка на проект</a>
...
> <a href="Проект №6 SQL">Ссылка на проект</a>
...
> <a href="Проект №7 Python">Ссылка на проект</a>

<p>Выводы:<p>
<ol>
  <li>Итог №1. Статистическая значимость роста среднего платежа и роста конверсии подтверждена </li>
  <li>Итог №2. Исходы эксперимента противоречивы по городам, рекомендуем продолжить эксперимент, скорректировав группы по удаленным ТТ.</li>
