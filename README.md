...
## Проекты
<p> Проект 1: Анализ работы онлайн кинотеатра. Калькулятор юнит-экономики кинотеатра</p>
...
<p>Как решала: Провела аналитику по каждому пункту. Выводы собрала в .pdf файле плюс добавила выводы.<p>
